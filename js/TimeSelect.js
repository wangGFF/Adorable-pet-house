    		...
    		var sjObj=o;
		        ...
		        sjObj.defaults={
		            ...
		            df_btn:function(){
		                ...
		                return $("<div class='df-btn' style='height:"+sjObj.opt.height+"px'><div class='df-no'>"+sjObj.opt.cancelText+"</div><div class='df-ok'>"+sjObj.opt.okText+"</div></div>")
		            },
		            ...
		            getArr:function(){
		                //按时间生成分钟，小时，月天数，月份
		                for(var i=0;i<60;i++){
		                    if(i<12&&!options.mmArr)this.mmArr[i]=(i+1)+"个月";
		                    // if(i<31&&!options.ddArr)this.ddArr[i]=(i+1)+"日";
		            ...
		            getYear:function(){
		                if(!this.startYear&&!options.yyArr){
		                    ...
		                    for (var x=this.y,i=0;x!=0;sjObj.opt.y>0?x--:x++,i++) {
		                        // if(sjObj.opt.y<0){
		                        //     sjObj.opt.yyArr[i]=nowTime.getFullYear()+x+1+"年";
		                        // }else{
		                        //     sjObj.opt.yyArr[i]=nowTime.getFullYear()+i+"年";
		                        // }
		                    }
		                    sjObj.opt.getArr()
		                }
